...
<body>
	<table id="box" align="center" width="850" border="0" cellpadding="0"
		cellspacing="0">
		<tr>
			<td colspan="5"
				style="width: 800px; height: 300px; background-color: silver;"><img
				src="/data/photo_2.png" width="100%" height="100%"></td>
		</tr>
			...
			<td colspan="5" id="list">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr align="center" height="20px"
						...
						<td width="50">1</td>
						<td width="303">다녀오개 첫글입니다.</td>
						<td width="100">관리자</td>
						<td width="100">2016/06/09</td>
						<td width="50">9</td>
					</tr>
					<tr>
		...
		<tr>
			<td height="30" colspan="5" align="right" style="padding-right: 2px;"><a
				href="write.jsp"><img src="/images/write_5.png" width="61"
		...
		<tr>
			<td height="20" colspan="5" align="center" id="copyright">Copyright
				byounghoonji All Rights Reserved</td>
		</tr>
	</table>
</body>
</html>
